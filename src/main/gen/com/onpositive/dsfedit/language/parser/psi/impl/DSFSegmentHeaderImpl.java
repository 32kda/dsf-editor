...
public class DSFSegmentHeaderImpl extends ASTWrapperPsiElement implements DSFSegmentHeader {

  public DSFSegmentHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSFVisitor visitor) {
    visitor.visitSegmentHeader(this);
  }
