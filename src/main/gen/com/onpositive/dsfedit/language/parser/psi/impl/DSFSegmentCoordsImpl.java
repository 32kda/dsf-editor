...
public class DSFSegmentCoordsImpl extends ASTWrapperPsiElement implements DSFSegmentCoords {

  public DSFSegmentCoordsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSFVisitor visitor) {
    visitor.visitSegmentCoords(this);
  }
