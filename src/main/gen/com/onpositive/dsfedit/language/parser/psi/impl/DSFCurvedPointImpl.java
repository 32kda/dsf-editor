...
public class DSFCurvedPointImpl extends ASTWrapperPsiElement implements DSFCurvedPoint {

  public DSFCurvedPointImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSFVisitor visitor) {
    visitor.visitCurvedPoint(this);
  }
