...
public class DSFSimplePointImpl extends ASTWrapperPsiElement implements DSFSimplePoint {

  public DSFSimplePointImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DSFVisitor visitor) {
    visitor.visitSimplePoint(this);
  }
